file_in_ja = ARGV[0]
file_in_vi = ARGV[1]
name_out_ja = file_in_ja.gsub("ja", "corpus_ja")
name_out_vi = file_in_vi.gsub("vi", "corpus_vi")

# file_out = vi = File.open(name_out,"w")
# Ubuntu/corpus_vi/gsettings-desktop-schemas.doc
# Ubuntu/corpus_ja/gsettings-desktop-schemas.doc
